...
const setRandomName1 = () => {
    document.getElementById('random_name').innerText = getRandomName1();
}

const setRandomName2 = () => {
    document.getElementById('random_name').innerText = getRandomName2();
}

const setRandomName3 = () => {
    document.getElementById('random_name').innerText = getRandomName3();
}
